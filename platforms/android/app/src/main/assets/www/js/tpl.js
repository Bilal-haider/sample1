...
function cartFooter(currency_code)
{
  var htm='';  
   htm+='<ons-row class="row cart-total-wrap">';
      htm+='<ons-col class="concat-text" width="25%" style="text-align:right">';
        htm+='<button class="button button--quiet" onclick="addCartQty(1)">';
          htm+='<ons-icon class="icon-green" icon="fa-minus"></ons-icon>';
        htm+='</button>';
      htm+='</ons-col>';
      htm+='<ons-col class="" width="50%">';
      
         htm+='<ons-row class="row grey-border-bottom">';
            
             htm+='<ons-col>';
             htm+='<input name="qty" type="number" style=" text-align:center;font-weight: bold;font-size:25px;" class="qty numeric_only text-input text-input--transparent" value="1">';
             htm+='</ons-col>';
         htm+='</ons-row>';
